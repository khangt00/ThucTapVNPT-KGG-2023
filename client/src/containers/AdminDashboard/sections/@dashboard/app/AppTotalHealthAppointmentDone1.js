...
import { getTotalHealthAppointmentDone1 } from "../../../../../services/userService";
  ...
  return (
    <RootStyle>
      ...
      <Typography variant="subtitle2" sx={{ opacity: 0.72 }}>
          <FormattedMessage id={"admin-dashboard.dashboard.total-health-appointment-done1"} />
      </Typography>
    </RootStyle>
  );
}
